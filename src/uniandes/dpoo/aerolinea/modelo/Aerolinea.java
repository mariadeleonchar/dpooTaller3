...
public class Aerolinea
{
    ...
    public void programarVuelo( String fecha, String codigoRuta, String nombreAvion ) throws Exception
    {
        for (Vuelo vuelo:vuelos)
        {
        	...
        	vuelos.add(new Vuelo(null, nombreAvion, null));
        }
    ...
    {	
    	...
    	return v.venderTiquetes(this.getCliente(identificadorCliente), null,  cantidad)*cantidad;
    ...
    public int consultarSaldoPendienteCliente( String identificadorCliente )
    {
        ...
        {
        	if (tiquete.getCliente().equals(this.getCliente(identificadorCliente)))
        	{
        		return tiquete.getTarifa();        	}
        }
        return 0;
    }
